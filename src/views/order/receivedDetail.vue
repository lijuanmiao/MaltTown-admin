          ...
          <el-col class="sect-right" :span="19">{{data.mainOrder.identity}}</el-col>
			...
			<el-row style="margin-top:15px;margin-bottom:10px;">
				<el-col :span="16">
					...
					<el-button type="primary" @click="showLogistics(data.subOrder)" v-permissions="'DD020103'" size="mini">查看物流</el-button>
					<el-button type="warning" @click="editLogistics(data.subOrder)" v-permissions="'DD020104'" size="mini">修改物流</el-button>
			...
			<el-table class="table-table orderTableBottom" :data="RESULT_DATA.resultList" :border="true" @filter-change="filterList" v-loading="LOADING"
