          ...
          <el-row>
            ...
            <el-col :span="18" style="float:right;line-height:30px;margin-top:-5px">
              <div style="min-width:450px; ">
                ...
                >复制</el-button>
                <!-- <el-button type="primary" size="mini"   @click="showAddress(data.address)"  v-permissions="'DD030101'" >修改订单收货地址</el-button> -->
              </div>
              <el-row
      ...
      <el-form :model="SendGoodsForm"   :label-width="FORM_LABEL_WIDTH" :inline="true"  ref='SendGoodsForm' :rules="editForm2"  >
        <el-dialog :title="'手动发货'" :visible.sync="dialogSendGoods" :close-on-click-modal='false' width="900px">
          ...
          <div class="wuliu_image" >
            ...
            <div v-for="(good, index) in lastGoodList" :key="index" style="float:left;width:100%">
              <ul style="float:left;width:calc(73% - 20px);padding:10px;background:#f4f4f4;margin-bottom:3px">
              ...
              <el-button type="warning" @click="addGood(good.id,index)" v-if="!imgOnList[index]" style="float:right;margin-top:30px">选择</el-button>
              <span v-if="imgOnList[index]" style="color:#409eff;float:right;margin-top:30px;text-align:left">
                已选择<br/>
                <u style="color:#666;" @click="addGood(good.id,index)" >取消</u>
              </span>
              </ul>
            </div>
          </div>
